...
Global Peer是一个BGP Speaker，需要手动在calico中创建，所有的node都会与Global peer建立BGP连接。
	...
	A typical use case for a global peer might be a mid-scale deployment where all of the calico nodes are on the same L2 network and are each peering with the same Route Reflector (or set of Route Reflectors).
...
例如当集群规模进一步扩大的时候，可以使用[AS Per Pack model](https://docs.projectcalico.org/v2.1/reference/private-cloud/l3-interconnect-fabric#the-as-per-rack-model):
...
[calico over an Ethernet interconnect fabric](https://docs.projectcalico.org/v2.1/reference/private-cloud/l2-interconnect-fabric)中介绍了在Ethernet interconnect fabric部署calico网络方案。在每个vlan中部署一套calico。

![](images/calico-getting-started-1.jpg?raw=true)
...
![](images/calico-getting-started-2.jpg?raw=true)

TOR三层联通：


![](images/calico-getting-started-3.jpg?raw=true)
...
这种方式消耗了大量的AS，[RFC 4893 - BGP Support for Four-octet AS Number Space](http://www.faqs.org/rfcs/rfc4893.html)中考虑将AS号增加到32位。

不是特别明白这种方式的好处在哪里。

TOR二层联通:

![](images/calico-getting-started-4.jpg?raw=true)

TOR三层联通:

![](images/calico-getting-started-5.jpg?raw=true)
...
[Felix](https://github.com/projectcalico/felix)负责管理设置node，

[bird](https://bird.network.cz/)是一个开源的软路由，支持多种路由协议。

## calico中的概念

[calicoctl resource definitions](https://docs.projectcalico.org/v2.1/reference/calicoctl/resources/)介绍了每类资源的格式。
...
PREROUTING@raw:
	...
	-A PREROUTING -m comment --comment "cali:6gwbT8clXdHdC1b1" -j cali-PREROUTING cali-PREROUTING@RAW:
...
[calico config](https://docs.projectcalico.org/v2.1/reference/calicoctl/commands/config)更改calico的配置项.
...
- [洪强宁：宜信PaaS平台基于calico的容器](http://www.sohu.com/a/60566915_384185)
- [calico architecture](https://docs.projectcalico.org/master/reference/architecture/)
- [felix code](https://github.com/projectcalico/felix)
- [felix bare-metal-install](http://docs.projectcalico.org/v2.1/getting-started/bare-metal/bare-metal-install)
- [calicoctl](https://docs.projectcalico.org/v2.1/reference/calicoctl/)
- [calicoctl config](http://docs.projectcalico.org/v2.1/reference/calicoctl/commands/config)
- [calicoctl resource definitions](http://docs.projectcalico.org/v2.1/reference/calicoctl/commands/config)
- [calico bgpPeer](https://docs.projectcalico.org/v2.1/usage/configuration/bgp)
- [AS Per Rack model](http://docs.projectcalico.org/v2.1/reference/private-cloud/l3-interconnect-fabric#the-as-per-rack-model)
- [calico over an Ethernet interconnect fabric](https://docs.projectcalico.org/v2.1/reference/private-cloud/l2-interconnect-fabric)
- [bird](https://bird.network.cz/)
- [ECMP](https://en.wikipedia.org/wiki/Equal-cost_multi-path_routing)
- [calico over ip fabrics](https://docs.projectcalico.org/v2.1/reference/private-cloud/l3-interconnect-fabric)
- [Use of BGP for routing in large-scale data centers](https://tools.ietf.org/html/draft-ietf-rtgwg-bgp-routing-large-dc-11)
- [RFC 4893 - BGP Support for Four-octet AS Number Space](http://www.faqs.org/rfcs/rfc4893.html)